...
echo.
echo [STEP 5/6] 🌙 Running End of Day Git Push Script...
...
start "Memory Agent" /D "%APP_ROOT%" cmd /k python -m agents.memory_manager
...
start "MCP Git Agent" /D "%APP_ROOT%" cmd /k python -m agents.git_agent
